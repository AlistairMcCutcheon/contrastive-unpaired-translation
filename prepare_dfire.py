...
DATA_DIR_PATH = PurePath("datasets/")
...
def main():
    ...
    clean_and_copy(
        str(PurePath(DATA_DIR_PATH) / "dfire_train" / "trainB"),
        train_only_smoke_img_paths,
    )
    clean_and_copy(
        str(PurePath(DATA_DIR_PATH) / "dfire_train" / "trainA"),
        train_empty_img_paths,
    )
    clean_and_copy(
        str(PurePath(DATA_DIR_PATH) / "dfire_test" / "trainB"),
        test_only_smoke_img_paths,
    )
    clean_and_copy(
        str(PurePath(DATA_DIR_PATH) / "dfire_test" / "trainA"),
